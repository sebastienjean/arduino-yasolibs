...
private:
   ...
   */
  GPS_status_enum
  readGGA(char *nmeaSentenceBuffer);
...
protected:
   ...
   */
  GPS_status_enum
  parseGGA(char *nmeaSentenceBuffer);
...
public:
   ...
   */
  GPS3D(Stream *in, uint16_t millisecondsTimeout, uint16_t charsTimeout,
      Stream *out);
