...
void
FSK600BaudTA900TB1500Mod::generateTone(bool bit)
{
 ...
 */
size_t
FSK600BaudTA900TB1500Mod::write(uint8_t c)
{
  int loopByte;
...
int
FSK600BaudTA900TB1500Mod::read()
{
  return -1;
}
int
FSK600BaudTA900TB1500Mod::available()
{
  return 0;
}
void
FSK600BaudTA900TB1500Mod::flush()
{
}
;
int
FSK600BaudTA900TB1500Mod::peek()
{
  return -1;
}
